...
$string['choosereadme'] = 'foundation is a special minimalist theme with only basic layout. It is intended as a starting point for other themes to build upon.  It is not recommend to actually choose this theme for production sites!';

// Settings
$string['notes'] = 'Theme notes';
$string['notesdesc'] = '<p>Foundation is intended to be a parent theme.  Currently parent theme settings cannot be inherited by child themes.  If you want custom settings you must create a child theme with its own settings page.</p>';
